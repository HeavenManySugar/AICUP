...
data["PredictPower"] = main.PowerPredict("main_model.joblib", data_main)
...
def objective(trial):
    ...
    model.fit(X_train_sub, y_train_sub, eval_set=[(X_test, y_test)])
...
# Save the model
joblib.dump(best_model, "main_model_stack2.joblib")
