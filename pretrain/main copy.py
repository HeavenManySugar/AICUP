import joblib
import pandas as pd
from WeatherPredict_copy import WeatherPredict
import numpy as np
...
if __name__ == "__main__":
    csv_path = "ExampleTestData/upload.csv"
    data = pd.read_csv(csv_path)

    y_pred = PowerPredict("main_model_pure.joblib", "weather_model_pure.joblib", data)
